...
Imports System.Data
Public Class OTCODMAST
    Inherits CoreBusiness.Maintain

    Dim LogError As LogError = New LogError()

    Public Sub New()
        ATTR_TABLE = "OTCODMAST"
    End Sub
...
#Region " Overrides functions "
    Overrides Function CheckBeforeAdd(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            Dim v_strLocal, v_strOTCODID, v_strParentId As String
            ...
            v_strSQL = "SELECT COUNT(*) FROM " & ATTR_TABLE & " WHERE OTCODID = '" & v_strOTCODID & "'  and DELTD <> 'Y'"
    ...
    Overrides Function CheckBeforeEdit(ByVal v_strMessage As String) As Long
        ...
        Try
            Dim v_attrColl As Xml.XmlAttributeCollection = pv_xmlDocument.DocumentElement.Attributes
            Dim v_strLocal, v_strClause, v_strOTCODID, v_strAUTOID As String
            Dim v_strFLDNAME, v_strFLDTYPE, v_strVALUE As String
            Dim v_strSQL As String
            ...
            'Kiểm tra ESCROWID không được trùng
            v_strSQL = "SELECT COUNT(*) FROM " & ATTR_TABLE & " WHERE OTCODID = '" & v_strOTCODID & "' and DELTD <> 'Y' and autoid <> " & v_strAUTOID
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count = 1 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_EA_ESCROWID_DUPLICATED
    ...
    Overrides Function Delete(ByRef v_strMessage As String) As Long
        ...
        Dim pv_xmlDocument As XmlDocumentEx = gf_String2XMLDocumentEx(v_strMessage)
        Try
            v_lngErrCode = CoreDeleteObject(pv_xmlDocument)
...
#Region " Private methods "
    Private Function CoreDeleteObject(ByRef pv_xmlDocument As XmlDocumentEx) As Long
        Dim v_lngErrorCode As Long
