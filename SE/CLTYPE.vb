...
#Region " Overrides functions "
    Overrides Function CheckBeforeAdd(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            Dim v_strLocal, v_strACTYPE, v_strCCYCD, v_strGLGRP As String
            ...
            If v_ds.Tables(0).Rows.Count = 1 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_SE_ACTYPE_DUPLICATED
                End If
            End If
            ...
            If v_strGLGRP.Length > 0 Then
                v_strSQL = "SELECT COUNT(GLGRP) FROM GLREF WHERE APPTYPE = 'SE' AND GLGRP = '" & v_strGLGRP & "'"
                v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
                If v_ds.Tables(0).Rows.Count = 1 Then
                    If v_ds.Tables(0).Rows(0)(0) = 0 Then
                        Return ERR_SE_GLGRP_NOTFOUND
                    End If
                End If
            End If
    ...
    Overrides Function CheckBeforeDelete(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            'Không cho phép xoá loại CK có ràng buộc trong bảng CLMAST
            v_strSQL = "SELECT COUNT(ACTYPE) FROM CLMAST WHERE 0=0 AND " & v_strClause
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count = 1 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
