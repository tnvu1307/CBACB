...
#Region "Private Sub"
    ...
    Private Sub OnExport()
        Try
            ...
            End If
        Catch ex As Exception
            LogError.Write("Error source: @DIRECT.frmSearchCMP2FILE.OnExport" & vbNewLine _
                         & "Error code: System error!" & vbNewLine _
                         & "Error message: " & ex.Message, EventLogEntryType.Error)
    ...
    Private Sub GetOldData_bk()
        ...
        Try
            ...
            Next
        Catch ex As Exception
            LogError.Write("Error source: @DIRECT.frmSearchCMP2FILE.OnCompare" & vbNewLine _
                                   & "Error code: System error!" & vbNewLine _
                                   & "Error message: " & ex.Message, EventLogEntryType.Error)
            MessageBox.Show(ex.Message, gc_ApplicationTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub GetNewDataFromXML()
        ...
        Catch ex As Exception
            ' v_fsReadXsd.Close()
            v_fsReadXml.Close()
            LogError.Write("Error source: @DIRECT.frmCompareTradingResult.OnCompare" & vbNewLine _
                       & "Error code: System error!" & vbNewLine _
                       & "Error message: " & ex.Message, EventLogEntryType.Error)
            MessageBox.Show(ex.Message, gc_ApplicationTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Function ReadCSV(ByVal path As String, ByVal ConvertTypeCSV As Char()) As System.Data.DataTable
        ...
        Catch ex As Exception
            'Throw ex
            LogError.Write("Error source: @DIRECT.frmSearchCMP2FILE.GetNewData.ReadCSV" & vbNewLine _
                       & "Error code: System error!" & vbNewLine _
                       & "Error message: " & ex.Message, EventLogEntryType.Error)
            MessageBox.Show(ex.Message, gc_ApplicationTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Function ConvertDataFromDataTable(ByVal pv_data As DataTable) As String
        Try
            ...
            Return v_strDataTmp
        Catch ex As Exception
            LogError.Write("Error source: @DIRECT.frmSearchCMP2FILE.OnWrite" & vbNewLine _
                    & "Error code: System error!" & vbNewLine _
                    & "Error message: " & ex.Message, EventLogEntryType.Error)
            MessageBox.Show(ex.Message, gc_ApplicationTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub OnBrowser()
        Try
            ...
            End If
        Catch ex As Exception
            LogError.Write("Error source: @DIRECT.frmSearchCMP2FILE.OnBrowser" & vbNewLine _
                         & "Error code: System error!" & vbNewLine _
                         & "Error message: " & ex.Message, EventLogEntryType.Error)
            MessageBox.Show(ex.Message, gc_ApplicationTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
