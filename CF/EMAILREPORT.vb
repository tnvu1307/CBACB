...
#Region " Overrides functions "
    Overrides Function CheckBeforeAdd(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            Dim v_strACCOUNT, v_strBANKACC, v_strAFACCTNO, v_strTYPE, v_strCUSTID, v_strFEECD, v_strREGISTTYPE As String
            ...
            For i As Integer = 0 To v_nodeList.Item(0).ChildNodes.Count - 1
                With v_nodeList.Item(0).ChildNodes(i)
                    ...
                    Select Case Trim(v_strFLDNAME)
                        ...
                        Case "REGISTTYPE"
                            v_strREGISTTYPE = Trim(v_strVALUE)
                    End Select
                End With
            Next
            ...
            v_strSQL = "select count(*) from EMAILREPORT WHERE custid = '" & v_strCUSTID & "' and registtype = '" & v_strREGISTTYPE & "' and deltd <> 'Y' "
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count > 0 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_CF_DUPLICAT_REGISTTYPE
                End If
            End If
    ...
    Overrides Function CheckBeforeEdit(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            Dim v_strACCOUNT, v_strBANKACC, v_strAFACCTNO, v_strTYPE, v_strCUSTID, v_strFEECD, v_strREGISTTYPE, v_strAUTOID As String
            ...
            v_strSQL = "select count(*) from EMAILREPORT WHERE  deltd <> 'Y' and custid = '" & v_strCUSTID & "' and registtype = '" & v_strREGISTTYPE & "'  and autoid <> '" & v_strAUTOID & "'"
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count > 0 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_CF_DUPLICAT_REGISTTYPE
