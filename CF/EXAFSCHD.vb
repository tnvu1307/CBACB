...
#Region " Overrides functions "
    ...
    Overrides Function CheckBeforeAdd(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            Dim v_strFLDNAME, v_strFLDTYPE, v_strVALUE, v_strEFFECTIVEDT, v_strEXPDATE As String
            ...
            v_strSQL = "SELECT COUNT(AFACCTNO) FROM " & ATTR_TABLE & _
                        ...
                        " AND EXTYPE = '" & v_strEXTYPE & "' " & _
                        " AND EFFECTIVEDT = to_date('" & v_strEFFECTIVEDT & "','dd/mm/yyyy') "
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count = 1 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_CF_EXAFSCHD_DUPLICATED
                End If
            End If
            ' Check ngay het han trong exafmast nho hon ngay thuc hien trong EXAFSCHD
            v_strSQL = "SELECT COUNT(AFACCTNO) FROM EXAFMAST " & _
                        " WHERE AFACCTNO = '" & v_strAFACCTNO & "' " & _
                        " AND MODCODE = '" & v_strMODCODE & "' " & _
                        " AND EVENTCODE = '" & v_strEVENTCODE & "' " & _
                        " AND EXTYPE = '" & v_strEXTYPE & "' " & _
                        " AND EXPDATE >= to_date('" & v_strEFFECTIVEDT & "','dd/mm/yyyy') "
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count = 1 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_CF_EXAFSCHD_DUPLICATED
    ...
    Overrides Function CheckBeforeEdit(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            If v_lngErrCode <> 0 Then
                ...
                v_strErrorSource = "EXAFSCHD.Inquiry"
