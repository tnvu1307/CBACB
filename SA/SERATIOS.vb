...
#End Region
    Overrides Function CheckBeforeAdd(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            If v_dtFrdate > v_dtTodate Then
                Return ERR_SA_SERATIOS_CHECK_DATE
            End If
    ...
    Overrides Function CheckBeforeEdit(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            v_strSQL = "SELECT *  from SERATIOS where " & v_strCLAUSE
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            ...
            If v_dtCurDate > v_dtOldFrdate And v_dtOldFrdate <> v_dtNewFrdate Then
                Return ERR_SA_SERATIOS_CHECK_FRDATE
            End If

            If v_dtCurDate > v_dtOldTodate And v_dtOldTodate <> v_dtNewTodate Then
                Return ERR_SA_SERATIOS_CHECK_TODATE
            End If
    ...
    Public Overrides Function CheckBeforeDelete(ByVal v_strMessage As String) As Long
        ...
        Dim v_strErrorSource As String = "SA.SERATIOS.CheckBeforeDelete", v_strErrorMessage As String
        ...
        Try
            ...
            If v_dtCurDate > v_dtOldFrdate Then
                Return ERR_SA_SERATIOS_CANT_DELETE
            End If
