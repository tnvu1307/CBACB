...
#Region " Overrides functions "
    ...
    Private Property UserLanguage As String

    Overrides Function ProcessAfterInquiry(ByRef pv_xmlDocument As XmlDocumentEx) As Long
        Dim v_lngErrCode As Long
        Try
            v_lngErrCode = GetReferenceData(pv_xmlDocument)
            Return v_lngErrCode
