...
Imports System.Data
Public Class REPROMREVIEWTERM
    Inherits CoreBusiness.Maintain

    Dim LogError As LogError = New LogError()

    Public Sub New()
        ATTR_TABLE = "REPROMREVIEWTERM"
    End Sub
...
#End Region
    ...
    Overrides Function CheckBeforeEdit(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            v_strSQL = "SELECT *  from REPROMREVIEWTERM where " & v_strCLAUSE
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
    ...
    Public Overrides Function CheckBeforeDelete(ByVal v_strMessage As String) As Long
        ...
        Dim v_strErrorSource As String = "SA.REPROMREVIEWTERM.CheckBeforeDelete", v_strErrorMessage As String
