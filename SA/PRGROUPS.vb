...
#Region "Override functions"
    Overrides Function CheckBeforeAdd(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            Dim v_strLocal, v_strPRCODE, v_strGRPID As String
            ...
            If v_strPRCODE.Length > 0 And v_strGRPID.Length > 0 Then
                v_strSQL = "SELECT COUNT(AUTOID) FROM PRGROUPS WHERE PRCODE = '" & v_strPRCODE & "' AND GRPID = '" & v_strGRPID & "'"
    ...
    Overrides Function CheckBeforeEdit(ByVal v_strMessage As String) As Long
        ...
        Try
            Dim v_attrColl As Xml.XmlAttributeCollection = pv_xmlDocument.DocumentElement.Attributes
            Dim v_strLocal, v_strPRCODE, v_strGRPID, v_strAUTOID As String
            Dim v_strFLDNAME, v_strFLDTYPE, v_strVALUE As String
            Dim v_strSQL As String
            ...
            If v_strPRCODE.Length > 0 And v_strGRPID.Length > 0 Then
                v_strSQL = "SELECT COUNT(AUTOID) FROM PRGROUPS WHERE AUTOID<>" & v_strAUTOID & " AND PRCODE = '" & v_strPRCODE & "' AND GRPID = '" & v_strGRPID & "'"
                v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_PRDETAIL_DUPLICATED
                End If
