...
Imports System.Data
Public Class USERVALIDRULE
    Inherits CoreBusiness.Maintain

    Dim LogError As LogError = New LogError()

    Public Sub New()
        ATTR_TABLE = "USERVALIDRULE"
    End Sub
...
#Region " Overrides functions "
    ...
    Overrides Function CheckBeforeDelete(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            '    v_strSQL = "SELECT COUNT(BRID) FROM USERVALIDRULE WHERE BRID = '" & v_strCurrentBrId & "' AND " & v_strClause
            ...
            'v_strSQL = "SELECT COUNT(BRID) FROM USERVALIDRULE WHERE PRBRID " & Mid(v_strClause, InStr(v_strClause, "="))
            'v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            'If v_ds.Tables(0).Rows.Count = 1 Then
            '    If v_ds.Tables(0).Rows(0)(0) > 0 Then
