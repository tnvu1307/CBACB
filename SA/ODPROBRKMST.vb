...
Imports System.Data
Public Class ODPROBRKMST
    Inherits CoreBusiness.Maintain

    Dim LogError As LogError = New LogError()

    Public Sub New()
        ATTR_TABLE = "ODPROBRKMST"
    End Sub
...
#Region " Overrides functions "
    ...
    Public Overrides Function CheckBeforeDelete(ByVal v_strMessage As String) As Long
        ...
        Dim v_strErrorSource As String = "SA.ODPROBRKMST.CheckBeforeDelete", v_strErrorMessage As String
        ...
        Try
            ...
            v_strSQL = "SELECT count (1) a from odprobrkaf where REF" & v_strCLAUSE
    ...
    Public Overrides Function SystemProcessBeforeDelete(ByRef v_strMessage As String) As Long
        ...
        Dim pv_xmlDocument As XmlDocumentEx = gf_String2XMLDocumentEx(v_strMessage)
        Dim v_attrColl As Xml.XmlAttributeCollection = pv_xmlDocument.DocumentElement.Attributes
        Dim v_strErrorSource As String = "SA.ODPROBRKMST.SystemProcessBeforeDelete", v_strErrorMessage As String
        Try
            If Not (v_attrColl.GetNamedItem(gc_AtributeLOCAL) Is Nothing) Then
                v_strLocal = CStr(CType(v_attrColl.GetNamedItem(gc_AtributeLOCAL), Xml.XmlAttribute).Value)
            Else
            ...
            ElseIf v_strLocal = "N" Then
                ...
                v_obj.NewDBInstance(gc_MODULE_HOST)
            End If
            v_strSQL = "INSERT INTO odprobrkmstlog select * from odprobrkmst where " & v_strCLAUSE
