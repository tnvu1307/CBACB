...
#Region " Overrides functions "
    Overrides Function CheckBeforeAdd(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            Dim v_strLocal, v_strCUSTODYCD, v_strFEECD, v_strAUTOID As String
            ...
            'Kiểm tra phí không được trùng
            'thunt-06/01/2020
            v_strSQL = "SELECT COUNT(*) FROM " & ATTR_TABLE & " WHERE FEECD = '" & v_strFEECD & "' AND CUSTODYCD = '" & v_strCUSTODYCD & "'"
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count > 0 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_SA_CFFCFFEEEXP_EXIT
                End If
            End If
            'Kiểm tra số tự tăng không được trùng
            v_strSQL = "SELECT COUNT(*) FROM " & ATTR_TABLE & " WHERE AUTOID = '" & v_strAUTOID & "'"
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count > 0 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_SA_CFFCFFEEEXP_AUTOID_WRONG
                End If
            End If
    ...
    Overrides Function CheckBeforeEdit(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            Dim v_strSQL As String
            Dim v_strCUSTODYCD, v_strAUTOID, v_strFEECD As String
            ...
            'Kiểm tra phí không được trùng
            'thunt-06/01/2020
            v_strSQL = "SELECT COUNT(*) FROM " & ATTR_TABLE & " WHERE FEECD = '" & v_strFEECD & "' AND CUSTODYCD = '" & v_strCUSTODYCD & "' AND AUTOID <> '" & v_strAUTOID & "'"
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count > 0 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return ERR_SA_CFFCFFEEEXP_EXIT
