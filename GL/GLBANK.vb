...
#Region " Overrides functions "
    Overrides Function CheckBeforeAdd(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            Dim v_strLocal, v_strGLBANK As String
            ...
            'Kiểm tra GLBANK không được trùng
            v_strSQL = "SELECT COUNT(GLBANK) FROM " & ATTR_TABLE & " WHERE GLBANK = '" & v_strGLBANK & "'"
            v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
            If v_ds.Tables(0).Rows.Count = 1 Then
                If v_ds.Tables(0).Rows(0)(0) > 0 Then
                    Return gc_ERRCODE_GL_GLBANK_DUPLICATED
                End If
            End If
    ...
    Overrides Function CheckBeforeDelete(ByVal v_strMessage As String) As Long
        ...
        Try
            ...
            'Kiểm tra GLBANK có sử dụng trong bảng GLMAST không?
            If v_strCurrentBdsid <> String.Empty Then
                v_strSQL = "SELECT COUNT(GLBANK) FROM GLMAST WHERE 0=0 AND " & v_strClause
                v_ds = v_obj.ExecuteSQLReturnDataset(CommandType.Text, v_strSQL)
                If v_ds.Tables(0).Rows.Count >= 1 Then
                    If v_ds.Tables(0).Rows(0)(0) > 0 Then
                        Return ERR_GL_GLBANK_CONSTRAINTS
                    End If
                End If
            End If
            If Not (v_ds Is Nothing) Then
