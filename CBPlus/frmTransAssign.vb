...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Node1 = New Xceed.SmartUI.Controls.TreeView.Node("@DIRECT - Transaction", 2)
        ...
        Me.Node1.Name = "Node1"
        Me.Node1.Text = "@DIRECT - Transaction"
        '
        'imlMenu
        '
...
#Region " Overridable methods "
    Public Overridable Sub OnInit()
        Try
            ...
            DoResizePanel()
            mv_ResourceManager = New Resources.ResourceManager("_DIRECT.frmTransAssign-" & UserLanguage, System.Reflection.Assembly.GetExecutingAssembly())
    ...
    Private Sub SetParentNodeKey(ByVal pv_treeNode As Node)
        ...
        Dim v_strCMDALLOW, v_strPRLEV, v_strMODCODE, v_strMenuType, v_arrAuth() As String
        Dim v_strPRCMDALLOW, v_strOldHashValue, v_arrPRAuth(), v_arrChild() As String
