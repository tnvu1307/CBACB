...
#Region " Khai báo hằng, biến "
    Const c_ResourceManager = "_DIRECT.frmSyncToFIIN-"
...
#Region " Other methods "
    ...
    Protected Overridable Sub InitDialog()
        ...
        'loai 
        v_strCmdSQL = "SELECT CDVAL VALUECD,CDVAL VALUE,CDCONTENT DISPLAY , EN_CDCONTENT EN_DISPLAY,LSTODR FROM ALLCODE WHERE CDNAME = 'TOFIIN' AND CDTYPE = 'SE'  ORDER BY LSTODR"
        ...
        cboType.EditValue = "SYNC_ON_FIIN"
...
#End Region
    ...
    Private Sub btnsync_Click(sender As Object, e As EventArgs) Handles btnsync.Click
        ...
        Try
            v_strStoreName = "SP_SYNC_ON_FIIN"
            ...
            'v_strClauseParam = String.Format(str_sync_fiin_param, cboType.EditValue, dtFr.DateTime.ToString.Split(" ")(0) & "-" & dtFr.DateTime.ToString.Split(" ")(1) & "-" & dtFr.DateTime.ToString.Split(" ")(2), dtTo.DateTime.ToString.Split(" ")(0) & "-" & dtTo.DateTime.ToString.Split(" ")(1) & "-" & dtTo.DateTime.ToString.Split(" ")(2), "")
