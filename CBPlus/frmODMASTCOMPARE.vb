...
#Region " Khai báo hằng, biến "
    Const c_ResourceManager = "_DIRECT.frmODMASTCOMPARE-"
                                ...
                                For i = 0 To v_nodeList.Count - 1
                                    ...
                                    If v_strFLDCD <> "" Then
                                        If String.Compare(v_strFLDCD, "PD") = 0 Then
                                            ...
                                            If grvsbfundetf.SelectedRowsCount > 0 Then
...
#Region " Other methods "
    ...
    Protected Overridable Sub InitDialog()
        btnExecuteAll.Visibility = BarItemVisibility.Never
        ...
        'loai 
        v_strCmdSQL = "SELECT CDVAL VALUECD,CDVAL VALUE,CDCONTENT DISPLAY , EN_CDCONTENT EN_DISPLAY,LSTODR FROM ALLCODE WHERE CDNAME = 'ODMASTCOMPARE' AND CDTYPE = 'OD'  ORDER BY LSTODR"
        v_strObjMsg = BuildXMLObjMsg(, "000001", , "0001", gc_IsLocalMsg, gc_MsgTypeObj, OBJNAME_SA_LOOKUP, gc_ActionInquiry, v_strCmdSQL)
        v_ws.Message(v_strObjMsg)
        cboType.Refresh()
        cboType.EditValue = "OD8893"
...
#Region " Các sự kiện của form "
    ...
    Private Sub frmSearch_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
        ...
        Try
            Select Case e.KeyCode
                Case Keys.F6
                    If Not (gridsbfundetf Is Nothing) Then
                        If gridsbfundetf.Enabled And gridsbfundetf.Visible Then
                            gridsbfundetf.Focus()
                            'TODO:
                        End If
                    End If
            ...
            For v_intRow = 0 To grvsbfundetf.RowCount - 1 Step 1
                ...
                If Not grvsbfundetf.GetDataRow(v_intRow) Is Nothing Then
                    If Not pv_blnAll Then
                        If grvsbfundetf.GetDataRow(v_intRow)("__TICK").Value = "X" Then
                            ...
                            For v_intCol = 0 To grvsbfundetf.RowCount - 1
                                ...
                                Else
                                    v_attrFLDTYPE.Value = grvsbfundetf.Columns(v_intCol).ColumnType.ToString
                                End If
                                ...
                                'Set value
                                v_nodeEntry.InnerText = grvsbfundetf.GetDataRow(v_intRow)(v_intCol).Value
                    ...
                    Else
                        ...
                        v_xmlDocument.DocumentElement.AppendChild(v_nodeObjData)
                        countTick = grvsbfundetf.RowCount
                    End If
                End If
            Next v_intRow
    ...
    Private Sub grvsbfundetf_RowCellStyle(sender As Object, e As RowCellStyleEventArgs) Handles grvsbfundetf.RowCellStyle

        If cboType.EditValue.ToUpper() = "OD8893" Or cboType.EditValue.ToUpper() = "CLIENTBROKER" Or cboType.EditValue.ToUpper() = "CLIENTVSD" Or cboType.EditValue.ToUpper() = "VSDBROKER" Or cboType.EditValue.ToUpper() = "VSDCLIENT" Or cboType.EditValue.ToUpper() = "BROKERVSD" Or cboType.EditValue.ToUpper() = "CLIENTBROKERHIST" Or cboType.EditValue.ToUpper() = "CLIENTVSDHIST" Or cboType.EditValue.ToUpper() = "BROKERVSDHIST" Or cboType.EditValue.ToUpper() = "OD8893HIST" Then
            Dim gv = TryCast(sender, GridView)
            If e.Column.FieldName = "NOTE" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTE").ToString = "Mismatched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#F51D1D")
            ElseIf e.Column.FieldName = "NOTE1" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTE1").ToString = "Mismatched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#F51D1D")
            ElseIf e.Column.FieldName = "NOTE1" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTE1").ToString = "Matched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#56B81D")
            ElseIf e.Column.FieldName = "NOTE" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTE").ToString = "Matched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#56B81D")
            End If
        End If

        If cboType.EditValue.ToUpper() = "VSDBROKER" Or cboType.EditValue.ToUpper() = "OD8893" Or cboType.EditValue.ToUpper() = "OD8893HIST" Then
            Dim gv = TryCast(sender, GridView)
            If e.Column.FieldName = "NOTEVSBR" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTEVSBR").ToString = "Mismatched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#F51D1D")
            ElseIf e.Column.FieldName = "NOTEVSBR" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTEVSBR").ToString = "Matched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#56B81D")
            End If
        End If


        If cboType.EditValue.ToUpper() = "CLIENT" Or cboType.EditValue.ToUpper() = "BROKER" Then
            Dim gv = TryCast(sender, GridView)
            If e.Column.FieldName = "NOTE" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTE").ToString = "Mismatched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#F51D1D")
            ElseIf e.Column.FieldName = "NOTE" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTE").ToString = "Matched" Then
            ...
            ElseIf e.Column.FieldName = "NOTE1" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTE1").ToString = "Matched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#56B81D")
            ElseIf e.Column.FieldName = "NOTEVSBR" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTEVSBR").ToString = "Mismatched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#F51D1D")
            ElseIf e.Column.FieldName = "NOTEVSBR" AndAlso e.RowHandle >= 0 AndAlso gv.GetRowCellValue(e.RowHandle, "NOTEVSBR").ToString = "Matched" Then
                e.Appearance.BackColor = ColorTranslator.FromHtml("#56B81D")
            End If
    ...
    Private Sub gvResult_CustomDrawFooter(sender As Object, e As DevExpress.XtraGrid.Views.Base.RowObjectCustomDrawEventArgs)
...
#End Region
    ...
    Private Sub cbotype_EditValueChanged(sender As Object, e As EventArgs) Handles cboType.EditValueChanged
        ...
        'Me.AuthCode = "NYNNYYYNNY"

        'Me.CMDTYPE = mv_strCMDTYPE
    ...
    Private Sub grvsbfundetf_CustomDrawFooter(sender As Object, e As Views.Base.RowObjectCustomDrawEventArgs) Handles grvsbfundetf.CustomDrawFooter
        Dim intTotalRows As Integer = grvsbfundetf.DataRowCount
        ...
        If UserLanguage = "VN" Then
            strFootText = String.Format("Tổng số bản ghi tìm thấy: {0}", intTotalRows)
        Else
            strFootText = String.Format("Total records found: {0}", intTotalRows)
        End If
