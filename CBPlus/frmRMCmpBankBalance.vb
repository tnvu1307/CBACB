...
Public Class frmRMCmpBankBalance
    Inherits FormBase
#Region " Contructor "
    Public Sub New()
...
#Region " Các sự kiện của form "
    ...
    Private Sub frmRMCmpBankBalance_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        MyBase.CloseTab()
    End Sub

    Private Sub frmRMCmpBankBalance_Load(sender As Object, e As EventArgs) Handles Me.Load
        InitExternal()
    ...
    Private Sub bbiBalanceCompare_ItemClick(sender As Object, e As ItemClickEventArgs) Handles bbiBalanceCompare.ItemClick
    ...
    Private Sub bbiInqBank_ItemClick(sender As Object, e As ItemClickEventArgs) Handles bbiInqBank.ItemClick
        Cursor.Current = Cursors.WaitCursor
        Cursor.Show()
        CType(e.Item, BarButtonItem).Enabled = False
...
#Region " Other methods "
    ...
    Private Sub initRefeshAuto()
        ...
        Catch ex As Exception
            LogError.Write("frmRMCmpBankBalance.initRefeshAuto. Error: " & vbNewLine & ex.Message & vbNewLine & ex.StackTrace, EventLogEntryType.Error)
            Throw ex
        Finally
        End Try
    End Sub
    ...
    Private Sub InitExternal()
        ...
        Try
            ...
            InitGridFromSearchCode(ObjectName, gridResult, gvResult, "", "Y", "Y", UserLanguage)
        ...
        Catch ex As Exception
            LogError.Write("frmRMCmpBankBalance.InitExternal Error: " & vbNewLine & ex.Message & vbNewLine & ex.StackTrace, EventLogEntryType.Error)
            Throw ex
        Finally
        End Try
    End Sub
    ...
    Private Sub BankRequest()
        ...
        Catch ex As Exception
            LogError.Write("frmRMCmpBankBalance.BankRequest Error: " & vbNewLine & ex.Message & vbNewLine & ex.StackTrace, EventLogEntryType.Error)
            Throw ex
        Finally
    ...
    Private Sub OnCompare()
        ...
        Catch ex As Exception
            LogError.Write("frmRMCmpBankBalance.OnCompare Error: " & vbNewLine & ex.Message & vbNewLine & ex.StackTrace, EventLogEntryType.Error)
            Throw ex
        Finally
        End Try
    End Sub
