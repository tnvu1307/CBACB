...
Public Class frmCWBIDDING
    Const c_ResourceManager As String = "_DIRECT.frmCWBIDDING-"
    ...
    Public Sub New(ByVal pv_strLanguage As String)
        ...
        LoadResource(Me)
        InitExternal()
        Me.Tltxcd = gc_BO_COMPLETE_BOND_BIDDING_BW
...
#Region "Private Functions"
    ...
    Private Sub LoadResource(ByRef pv_ctrl As Windows.Forms.Control)
        ...
        Next
        Me.Text = mv_ResourceManager.GetString("frmCWBIDDING")
    ...
    Private Sub allocCPSchd()
        Dim v_dblCMPFEE, v_dblCASHFEE, v_dblMinFee, v_dblREFEE, v_dblTOTALAMT, v_dblBIDDINGAMT, v_dblREMAININGAMT, v_dblCUTEDAMT, v_dblSUMRCAMT, v_dblREMAIN_DEALPAIDAMT As Double
        v_dblREMAIN_DEALPAIDAMT = mv_dblDEALPAIDAMT
        Dim v_dblRERATE, v_dblCASHRATE As Double
        Dim v_intMaxIndex As Integer
        Try
            v_dblCUTEDAMT = CDbl(Me.txtCUTEDAMT.Text)
            v_dblREMAININGAMT = CDbl(Me.txtREMAININGAMT.Text)
            v_dblBIDDINGAMT = CDbl(Me.txtBIDDINGAMT.Text)
            v_dblRERATE = CDbl(Me.txtRERATE.Text)
            v_dblCASHRATE = CDbl(Me.txtCASHRATE.Text)
            v_dblREFEE = CDbl(Me.txtREFEE.Text)
            v_dblCASHFEE = CDbl(Me.txtCASHFEE.Text)
            v_dblTOTALAMT = CDbl(Me.txtTOTALAMT.Text)
            ...
            v_dblREMAININGAMT = v_dblBIDDINGAMT - v_dblSUMRCAMT
            v_dblREFEE = v_dblBIDDINGAMT * v_dblRERATE / 100
            v_dblCASHFEE = v_dblBIDDINGAMT * v_dblCASHRATE / 100
            'v_dblTOTALAMT = v_dblBIDDINGAMT + v_dblREFEE + v_dblCASHFEE
            v_dblTOTALAMT = v_dblREMAININGAMT + v_dblREFEE + v_dblCASHFEE
            Me.txtREFEE.Text = Format(v_dblREFEE, "#,##0")
            Me.txtCASHFEE.Text = Format(v_dblCASHFEE, "#,##0")
            Me.txtCUTEDAMT.Text = Format(v_dblCUTEDAMT, "#,##0")
            Me.txtREMAININGAMT.Text = Format(v_dblREMAININGAMT, "#,##0")
            Me.txtTOTALAMT.Text = Format(v_dblTOTALAMT, "#,##0")
    ...
    Private Sub ResetScreen()
        Try
            ...
            'Me.dptISSUEDATE.Text = String.Empty
                ...
                For v_intIndex = 0 To mv_arrObjFields.GetLength(0) - 1 Step 1
                    If Not mv_arrObjFields(v_intIndex) Is Nothing Then
                        ...
                        If Me.cboBIDTYPE.SelectedValue = "001" Then
                            v_strFLDDesc = mv_ResourceManager.GetString("frmCWBIDDING_bidding")
                        Else
                            v_strFLDDesc = mv_ResourceManager.GetString("frmCWBIDDING_auction")
                        End If
                        ...
                        Select Case Trim(v_strFLDNAME)
                            ...
                            Case "04" 'BIDDINGAMT,N
                                v_strFLDVALUE = CDbl(Me.txtBIDDINGAMT.Text)
                            Case "10" 'TOTALAMT,N
                                v_strFLDVALUE = CDbl(Me.txtTOTALAMT.Text)
                            Case "05" 'CUTEDAMT,N
                                v_strFLDVALUE = CDbl(Me.txtCUTEDAMT.Text)
                            Case "06" 'REMAININGAMT,N
                                v_strFLDVALUE = CDbl(Me.txtREMAININGAMT.Text)
                            Case "07" 'RERATE,N
                                v_strFLDVALUE = CDbl(Me.txtRERATE.Text)
                            Case "08" 'REFEE,N
                                v_strFLDVALUE = CDbl(Me.txtREFEE.Text)
                            Case "09" 'CASHRATE,N
                                v_strFLDVALUE = CDbl(Me.txtCASHRATE.Text)
                            Case "11" 'CASHFEE,N
                                v_strFLDVALUE = CDbl(Me.txtCASHFEE.Text)
                            Case "88" 'CUSTODYCD,C
                                v_strFLDVALUE = Me.txtCUSTODYCD.Text.Replace(".", "").ToUpper
                                'Case "10" 'AMT,N
                                '    v_strFLDVALUE = CDbl(CPSchdGrid.DataRows(v_intRow).Cells("AMT").Value)
                            Case "13" 'LOGAUTOID,N
...
#Region "Control event"
    ...
    Private Sub txtBIDDINGAMT_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtBIDDINGAMT.Validating
        Dim dblBIDDINGAMT, dblCUTEDAMT, dblREMAININGAMT, dblREFEE, dblCASHFEE, dblTOTALAMT, dblRERATE, dblCASHRATE As Double
        Try
            Me.txtBIDDINGAMT.Text = Format(CDbl(Me.txtBIDDINGAMT.Text), "#,##0")
            dblCUTEDAMT = CDbl(Me.txtCUTEDAMT.Text)
            dblRERATE = CDbl(Me.txtRERATE.Text)
            dblCASHRATE = CDbl(Me.txtCASHRATE.Text)
            dblREFEE = CDbl(Me.txtREFEE.Text)
            dblCASHFEE = CDbl(Me.txtCASHFEE.Text)
            dblTOTALAMT = CDbl(Me.txtTOTALAMT.Text)
            dblREMAININGAMT = CDbl(Me.txtREMAININGAMT.Text)
            dblBIDDINGAMT = CDbl(Me.txtBIDDINGAMT.Text)
            If dblBIDDINGAMT < 0 Then
                MessageBox.Show(mv_ResourceManager.GetString("INVALIDBIDDINGAMT"), Me.Text, MessageBoxButtons.OK)
            Else
                dblREMAININGAMT = dblBIDDINGAMT - dblCUTEDAMT
                dblREFEE = dblRERATE * dblBIDDINGAMT / 100
                dblCASHFEE = dblCASHRATE * dblBIDDINGAMT / 100
                dblTOTALAMT = dblREMAININGAMT + dblREFEE + dblCASHFEE
                'Me.txtBIDDINGAMT.Text = Format(dblBIDDINGAMT, "#,##0")
                txtREMAININGAMT.Text = Format(dblREMAININGAMT, "#,##0")
                txtREFEE.Text = Format(dblREFEE, "#,##0")
                txtCASHFEE.Text = Format(dblCASHFEE, "#,##0")
                txtTOTALAMT.Text = Format(dblTOTALAMT, "#,##0")
            End If
        Catch ex As Exception
            MessageBox.Show(mv_ResourceManager.GetString("ERR_NUMBER_TYPE"), Me.Text, MessageBoxButtons.OK)
            Me.txtBIDDINGAMT.Focus()
        End Try
        
    End Sub

    Private Sub txtRERATE_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtRERATE.Validating, lblRERATE.Validating
        Dim dblBIDDINGAMT, dblCUTEDAMT, dblREMAININGAMT, dblREFEE, dblCASHFEE, dblTOTALAMT, dblRERATE As Double
        Try
            ...
            dblREMAININGAMT = CDbl(Me.txtREMAININGAMT.Text)
            If dblRERATE < 0 Then
                MessageBox.Show(mv_ResourceManager.GetString("INVALIDRERATE"), Me.Text, MessageBoxButtons.OK)
            Else
                dblREFEE = dblBIDDINGAMT * dblRERATE / 100
                dblTOTALAMT = dblREMAININGAMT + dblREFEE + dblCASHFEE
                txtREFEE.Text = Format(dblREFEE, "#,##0")
                txtTOTALAMT.Text = Format(dblTOTALAMT, "#,##0")
            End If
    ...
    Private Sub txtCASHRATE_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtCASHRATE.Validating, lblCASHRATE.Validating
        Dim dblBIDDINGAMT, dblCUTEDAMT, dblREMAININGAMT, dblREFEE, dblCASHFEE, dblTOTALAMT, dblCASHRATE As Double
        Try
            dblBIDDINGAMT = CDbl(Me.txtBIDDINGAMT.Text)
            dblCASHRATE = CDbl(Me.txtCASHRATE.Text)
            dblREFEE = CDbl(Me.txtREFEE.Text)
            ...
            dblTOTALAMT = CDbl(Me.txtTOTALAMT.Text)
            dblREMAININGAMT = CDbl(Me.txtREMAININGAMT.Text)
            If dblCASHRATE < 0 Then
                MessageBox.Show(mv_ResourceManager.GetString("INVALIDCASHRATE"), Me.Text, MessageBoxButtons.OK)
            Else
                dblCASHFEE = dblBIDDINGAMT * dblCASHRATE / 100
                dblTOTALAMT = dblREMAININGAMT + dblREFEE + dblCASHFEE
                txtCASHFEE.Text = Format(dblCASHFEE, "#,##0")
                txtTOTALAMT.Text = Format(dblTOTALAMT, "#,##0")
            End If
    ...
    Private Sub cboBIDTYPE_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboBIDTYPE.SelectedIndexChanged
        ...
        Try
            ...
            If Not mv_xmlCUSTOMER Is Nothing Then
                ...
                'If Me.cboBIDTYPE.Text = "---" Then
                'MessageBox.Show(mv_ResourceManager.GetString("CHECKBIDTYPE"), Me.Text, MessageBoxButtons.OK)
                'Me.cboBIDTYPE.Focus()
                'End If
            Else
            MessageBox.Show(mv_ResourceManager.GetString("INVALIDACCTNO"), Me.Text, MessageBoxButtons.OK)
    ...
    Private Sub cboBIDTYPE_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cboBIDTYPE.Validating
        ...
        End Try
    End Sub
    Private Sub cboBIDTYPE_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboBIDTYPE.Leave
        If Me.cboBIDTYPE.Text = "---" Then
            MessageBox.Show(mv_ResourceManager.GetString("CHECKBIDTYPE"), Me.Text, MessageBoxButtons.OK)
            Me.cboBIDTYPE.Focus()
        End If
    ...
    Private Sub frmCWBIDDING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmCWBIDDING_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
    ...
    Private Sub txtTOTALAMT_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtTOTALAMT.TextChanged
        Try
            If CDbl(txtTOTALAMT.Text) > 0 Or (CDbl(txtTOTALAMT.Text) = 0 And CDbl(txtBIDDINGAMT.Text) > 0) Then
                'Me.btnAdjust.Enabled = True
    ...
    Private Sub btnApply_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnApply.Click
        ...
        Try
            ...
            Else
                ...
                If CDbl(txtTOTALAMT.Text) >= 0 Then
