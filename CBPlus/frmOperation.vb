...
#Region " Declare constant and variables "
    Const c_ResourceManager = "_DIRECT.frmOperation-"
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnClose
        '
        Me.btnClose.Location = New System.Drawing.Point(512, 320)
        ...
        'btnSubmit
        '
        Me.btnSubmit.Location = New System.Drawing.Point(422, 320)
        ...
        'txtFeedBack
        '
        Me.txtFeedBack.Location = New System.Drawing.Point(8, 248)
        Me.txtFeedBack.Multiline = True
        Me.txtFeedBack.Name = "txtFeedBack"
        Me.txtFeedBack.Size = New System.Drawing.Size(592, 64)
        Me.txtFeedBack.TabIndex = 5
        '
        'btnCache
        '
        Me.btnCache.Location = New System.Drawing.Point(104, 320)
        ...
        'btnTicker
        '
        Me.btnTicker.Location = New System.Drawing.Point(8, 320)
        ...
        Me.pnInfo.Size = New System.Drawing.Size(592, 232)
        Me.pnInfo.TabIndex = 6
        '
        'chklistTasks
        '
        Me.chklistTasks.Items.AddRange(New Object() {"AUTOGV: Autorun general view", "SENDCMP: Send order from FO to company", "SENDGTC: Send GTC order from FO to company", "SYNCTRANS: Process asynchronous transaction", "START_VSMKTINFO: Start HoSE Listed market info download", "START_VNMKTINFO: Start HaSTC Listed market info download", "START_VSTRADE: Start HoSE Listed trading data download", "START_VNTRADE: Start HaSTC Listed trading data download", "GET_VSMARKETWATCH: Get HoSE Market watch", "GET_VNMARKETWATCH: Get HaSTC Market watch", "GET_ORDERBOOK: Get HoSE Order book", "GET_TRADEBOOK: Get HoSE Trade book", "START_MAP_STCORDERBOOK: Map exchange order book to company order book", "START_MAP_STCTRADEBOOK: Map exchange trade book to company order book", "START_MAP_SECURITIESINFO: Synchronize Securities with Stock Exchange", "SENDSMS: Asynchronize Send SMS Message"})
        Me.chklistTasks.Location = New System.Drawing.Point(8, 8)
        Me.chklistTasks.Name = "chklistTasks"
        Me.chklistTasks.Size = New System.Drawing.Size(576, 214)
        ...
        'chkAuto
        '
        Me.chkAuto.Location = New System.Drawing.Point(200, 320)
        ...
        'txtInterval
        '
        Me.txtInterval.Location = New System.Drawing.Point(312, 320)
...
#Region " Private function "
    Private Sub LoadResource(ByRef pv_ctrl As Windows.Forms.Control)
        ...
        If TypeOf (v_ctrl) Is System.Windows.Forms.CheckedListBox Then
            ...
            mv_ResourceManager.GetString("AUTOGV"), _
            mv_ResourceManager.GetString("SENDCMP"), _
            mv_ResourceManager.GetString("SENDHAGTC"), _
            mv_ResourceManager.GetString("SENDHOGTC"), _
            mv_ResourceManager.GetString("SENDHASL"), _
            mv_ResourceManager.GetString("SENDHOSL"), _
            mv_ResourceManager.GetString("SYNCTRANS"), _
            mv_ResourceManager.GetString("START_VSMKTINFO"), _
            mv_ResourceManager.GetString("START_VNMKTINFO"), _
            mv_ResourceManager.GetString("START_VSTRADE"), _
            mv_ResourceManager.GetString("START_VNTRADE"), _
            mv_ResourceManager.GetString("GET_VSMARKETWATCH"), _
            mv_ResourceManager.GetString("GET_VNMARKETWATCH"), _
            mv_ResourceManager.GetString("GET_ORDERBOOK"), _
            mv_ResourceManager.GetString("GET_TRADEBOOK"), _
            mv_ResourceManager.GetString("START_MAP_SECURITIESINFO"), _
            mv_ResourceManager.GetString("START_MAP_STCORDERBOOK"), _
            mv_ResourceManager.GetString("START_MAP_STCTRADEBOOK"), _
            mv_ResourceManager.GetString("SENDSMS"), _
            mv_ResourceManager.GetString("BAMTTRF"), _
            mv_ResourceManager.GetString("BFEETRF"), _
...
#End Region
    ...
    Private Sub frmOperation_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
