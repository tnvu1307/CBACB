...
Friend Class frmChangeOrderCustody_VN
    ...
    Friend Shared ReadOnly Property ResourceManager() As Global.System.Resources.ResourceManager
        Get
            If Object.ReferenceEquals(resourceMan, Nothing) Then
                Dim temp As Global.System.Resources.ResourceManager = New Global.System.Resources.ResourceManager("_DIRECT.frmChangeOrderCustody-VN", GetType(frmChangeOrderCustody_VN).Assembly)
                resourceMan = temp
            End If
            Return resourceMan
        End Get
    ...
    '''<summary>
    '''  Looks up a localized string similar to Không thể sửa lệnh đã khớp.
    '''</summary>
    ...
    '''<summary>
    '''  Looks up a localized string similar to Không đủ tiền để thực hiện giao dịch..
    '''</summary>
    ...
    '''<summary>
    '''  Looks up a localized string similar to Không đủ CK để thực hiện giao dịch..
    '''</summary>
    ...
    '''<summary>
    '''  Looks up a localized string similar to Không thể mua bán cùng phiên.
    '''</summary>
    ...
    '''<summary>
    '''  Looks up a localized string similar to Thay đổi số lưu ký.
    '''</summary>
    ...
    '''<summary>
    '''  Looks up a localized string similar to Bạn có chắc muốn gửi msg sửa lệnh?.
    '''</summary>
    ...
    '''<summary>
    '''  Looks up a localized string similar to Không thể thay đổi cờ P/C.
    '''</summary>
    ...
    '''<summary>
    '''  Looks up a localized string similar to Tạo message thành công!.
    '''</summary>
