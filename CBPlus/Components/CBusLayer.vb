...
Public Class CBusLayer
    ...
    Public CurrentTellerProfile As New HOAuthService.CTellerProfile
    'End TruongLD
    ...
    Public Function Login(ByVal pv_strUserName As String, ByVal pv_strPassword As String) As BusLayerResult
        ...
        If ticketResult = BusLayerResult.Success Then
            ...
            Try
                ...
                'TruongLD add when convert
                'newTellerProfile = CommonLibrary.modCommond.UseServiceClient(Function(client As HOAuthService.IHOAuthService)
                '                                                                 Dim request As HOAuthService.GetTellerProfileRequest = New HOAuthService.GetTellerProfileRequest
                '                                                                 request.ticket = mv_strTicket
                '                                                                 Return client.GetTellerProfile(request).GetTellerProfileResult
                '                                                             End Function)
                'End TruongLD
