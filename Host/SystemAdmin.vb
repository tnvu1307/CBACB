...
#Region " Adhoc functions "
    ...
    Public Function CoreBankExecute(ByRef pv_strObjMsg As String) As Long
        Dim v_lngErrCode As Long = ERR_SYSTEM_OK
        Dim v_strErrorSource As String = "Host.SystemAdmin.CoreBankExecute", v_strErrorMessage As String
        ...
        Try
            v_obj = New txRouter
            v_lngErrCode = v_obj.CoreBank(pv_strObjMsg)
        Catch ex As Exception
    ...
    Public Function BuyAmountTransfer(ByRef pv_strObjMsg As String) As Long
        Dim v_lngErrCode As Long = ERR_SYSTEM_OK
        Dim v_strErrorSource As String = "Host.SystemAdmin.BuyAmountTransfer", v_strErrorMessage As String
        Dim v_objTxRouter As New Host.txRouter
        Dim v_objBatch As New RM.Batch()
        Dim v_obj As New DataAccess()
