...
-----END PUBLIC KEY-----"
    ...
    'Public Function signXml(ByVal xmlMessage As String, ByVal tagSign As String) As String
    '    Dim csp As RSACryptoServiceProvider = New RSACryptoServiceProvider()
    '    csp.ImportParameters(Signature_PublicKey)

    '    Dim xmlDoc As New XmlDocument()
    '    xmlDoc.LoadXml(xmlMessage)

    '    Dim attr As XmlAttribute = xmlDoc.CreateAttribute(tagSign)
